...
```sh
git clone https://github.com/malleroid/emerald-synth-zed.git
ln -s "$(pwd)/emerald-synth-zed" ~/.local/share/zed/extensions/installed/emerald-synth
```

Then select "Emerald Synth" via `Cmd+K Cmd+T`.
